window.addEventListener("load", () => {
  ...
  form.addEventListener("submit", (e) => {
    //Previniendo la recarga de la pagina.
    e.preventDefault();

    //Checkeando que no se envie el input vacio.
    ...
    /*
    Creando elementos el en DOM y dandoles clases, types, values y
    formando padres/hijos
    */
